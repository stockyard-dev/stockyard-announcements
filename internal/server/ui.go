...
You can view existing announcements, but creating, editing, or deleting is locked until you start a 14-day free trial.
</div>
...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> ANNOUNCEMENTS</h1>
...
<script>
var A='/api';
var RESOURCE='announcements';
var TITLE_FIELD='title';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "body", "label": "Body", "type": "textarea"}, {"name": "author", "label": "Author", "type": "text"}, {"name": "priority", "label": "Priority", "type": "text"}, {"name": "channel", "label": "Channel", "type": "text"}, {"name": "pinned", "label": "Pinned", "type": "integer"}, {"name": "expires_at", "label": "Expires At", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
...
var t=b.textContent||'';
if(t.indexOf('New')!==-1||t.indexOf('Add')!==-1){
